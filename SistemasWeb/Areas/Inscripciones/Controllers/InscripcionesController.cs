...
namespace SistemasWeb.Areas.Inscripciones.Controllers
{
    ...
    public class InscripcionesController : Controller
    {
        ...
        public InscripcionesController(ApplicationDbContext context, UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, IWebHostEnvironment hostingEnviroment)
        {
        ...
        public async Task<IActionResult> Export()
        {
            ...
            var export = new ExportData(_hostingEnviroment, list, titles, "Inscripciones.xlsx", "Inscripciones");
